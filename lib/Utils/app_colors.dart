...
class AppColors {
  ...
  static const BLUE_COLOR = Color(0xff00A6CC);
  ...
  static const AMBER_COLOR = Color(0xffFFB800);
  ...
  static MaterialColor PRIMARY_SWATCH_COLOR =
      MaterialColor(0xffF07600, <int, Color>{
    50: Color(0xffF07600),
    100: Color(0xffF07600),
    200: Color(0xffF07600),
    300: Color(0xffF07600),
    400: Color(0xffF07600),
    500: Color(0xffF07600),
    600: Color(0xffF07600),
    700: Color(0xffF07600),
    800: Color(0xffF07600),
    900: Color(0xffF07600),
  });
}
